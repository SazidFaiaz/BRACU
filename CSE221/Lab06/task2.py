...
# array elements in pairs and check if for the minimum
# of the all the maximums of each pair. This is the time
# Pode where the two will meet. However, this check will
# not be applicable if the node is unreachable by any
# of the two. The (index + 1) is the node where
# will meet.
# they
